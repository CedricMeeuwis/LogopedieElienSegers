...
export class SpraakComponent {
  ...
  constructor(private sanitizer: DomSanitizer, private meta: Meta){
    ...
    this.meta.updateTag({ name: 'keywords', content: 'Logopedie, Elien, Segers, Arendonk, Spraakontwikkeling, Mondgewoonten' }, 'name=keywords');
    this.meta.updateTag({ name: 'description', content: 'Er is een onderscheid tussen spraakproblemen en afwijkende mondgewoonten of oromyofunctionele problemen, voor beide bestaan er methodieken om ze tijdelijk aan te verbeteren.' }, 'name=description');
  }
}
